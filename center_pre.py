...
sym_abs_pml_hard = np.loadtxt('./sym_absPresdata_PML_Hard.txt', skiprows=8)
sym_abs_pml_pml = np.loadtxt('./sym_absPresdata_PML_PML.txt', skiprows=8)

asym_abs_pml_hard=np.loadtxt('./asym_absPresdata_PML_Hard.txt', skiprows=8)
asym_abs_pml_pml = np.loadtxt('./asym_absPresdata_PML_PML.txt', skiprows=8)
...
# --------
ax[0, 0].plot(x_cen22sym, abs22_numsym, color='gray', lw=2.5, label=r"$\mathrm{sym\;PML{-}Hard\;2270\,Hz}$")
ax[0, 0].plot(x_cen22sym, abs22_sym, color='blue', lw=2.5, label=r"$\mathrm{sym\;PML{-}PML}$")
ax[0, 0].plot(x_cen22sym, abs(p_cent22sym)/(4), lw=2.5, color='black', label=r"${\mathrm{{Exp,sym}}}$")
...
# -----
ax[0, 1].plot(x_cen30sym, abs30_numsym, color='gray', lw=2.5,label=r"$\mathrm{sym\;PML{-}Hard\;3000\,Hz}$")
ax[0, 1].plot(x_cen30sym, abs30_sym, color='blue', lw=2.5, label=r"$\mathrm{sym\;PML{-}PML}$")
ax[0, 1].plot(x_cen30sym, abs(p_cent30sym)/(7.26), lw=2.5, color='black', label=r"${\mathrm{{Exp,sym}}}$")
...
# ------
ax[1, 0].plot(x_cen22asym, abs22_numasym, lw=2.5, color='gray', label=r"$\mathrm{asym\;PML{-}Hard\;2270\,Hz}$")
ax[1, 0].plot(x_cen22asym, abs22_asym, color='blue', lw=2.5, label=r"$\mathrm{asym\;PML{-}PML}$")
ax[1, 0].plot(x_cen22asym, abs(p_cent22asym)/(3.92), lw=2.5, color='black', label=r"${\mathrm{{Exp,asym}}}$")
...
# ----
ax[1, 1].plot(x_cen30asym, abs30_numasym, color='gray', lw=2.5, label=r"$\mathrm{asym\;PML{-}Hard\;3000\,Hz}$")
ax[1, 1].plot(x_cen30asym, abs30_asym, color='blue', lw=2.5, label=r"$\mathrm{asym\;PML{-}PML}$")
ax[1, 1].plot(x_cen30asym, abs(p_cent30asym)/(9.26), lw=2.5, color='black', label=r"${\mathrm{{Exp,asym}}}$")
